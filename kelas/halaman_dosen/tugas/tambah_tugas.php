	...
	<div class="container"><br><br>
		...
		<form action="tambah_aksi.php" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="judul_tugas" required="required">
			</div>
			<div class="form-group">
				<label>Petunjuk Tugas :</label>
				<textarea class="form-control" name="petunjuk_tugas" required="required"></textarea>
			</div>
			<div class="form-group">
				<label>File Tugas :</label>
				<input type="file" class="form-control" name="file_tugas" required="required">
			</div>			
			<!-- <div class="form-group">
				<label>Foto :</label>
