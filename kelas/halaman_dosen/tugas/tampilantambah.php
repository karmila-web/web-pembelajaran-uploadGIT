...
<html>
<head>
	<title>Pembelajaran Interaktif - Upload file materi</title>
	<meta charset="utf-8">
		...
		<table class="table table-bordered">
			...
			while($d = mysqli_fetch_array($data)){
				...
				<tr>
					...
					<td><?php echo $d['judul_materi']; ?></td>
					<td><?php echo $d['petunjuk_materi']; ?></td>
					<td><a href="halaman_pembelajaran/<?= $d['file_materi'] ?>"><?= $d['file_materi']?></a></td>
				</tr>
				<?php
			}
