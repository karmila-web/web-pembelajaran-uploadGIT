...
<body>
	<div class="container"><br><br>
		...
		<table class="table table-bordered">
			...
			<?php 
			$data = mysqli_query($koneksi,"SELECT * FROM tb_tugas WHERE mata_pelajaran = 'Pemprograman Java'");
			while($d = mysqli_fetch_array($data)){
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="deleteJ.php?id_tugas=<?= $d['id_tugas']; ?>" role="button"><i class="fas fa-trash-alt"></i></a> || <a class="btn btn-warning" href="edit.php?id_tugas=<?= $d['id_tugas']; ?>"><i class="fas fa-edit"></i></a></td>
				</tr>
				<?php
			}
