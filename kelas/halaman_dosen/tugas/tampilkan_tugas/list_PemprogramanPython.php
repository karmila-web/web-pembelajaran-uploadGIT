...
<body>
	<div class="container"><br><br>
		<h2 style="text-align: center;">List Tugas Pemrograman Python</h2>
		<?php 
		if(isset($_GET['alert'])){
		...
		<table class="table table-bordered">
			...
			<?php 
			$data = mysqli_query($koneksi,"SELECT * FROM tb_tugas WHERE mata_pelajaran = 'Pemprograman Python'");
			while($d = mysqli_fetch_array($data)){
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="deleteP.php?id_tugas=<?= $d['id_tugas']; ?>" role="button"><i class="fas fa-trash-alt"></i></a> || <a class="btn btn-warning" href="edit.php?id_tugas=<?= $d['id_tugas']; ?>"><i class="fas fa-edit"></i></a></td>
				</tr>
				<?php
			}
