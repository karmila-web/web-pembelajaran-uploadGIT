...
<body>
	<br><br>
	<div class="container">
		<h2 style="text-align: center;">List Materi Digital Marketing</h2>	
		<?php 
		if(isset($_GET['alert'])){
		...
		<table class="table table-bordered">
			...
			<?php 
			$data = mysqli_query($koneksi,"SELECT * FROM tb_materi WHERE mata_pelajaran = 'Digital Marketing'");
			while($d = mysqli_fetch_array($data)){
				...
				<tr>
					...
					<td><a class="btn btn-danger"  href="deleteD.php?id_materi=<?= $d['id_materi']; ?>" role="button"><i class="fas fa-trash-alt"></i></a> || <a class="btn btn-warning" href="edit.php?id_materi=<?= $d['id_materi']; ?>"><i class="fas fa-edit"></i></a></td>
				</tr>
				<?php
			}
