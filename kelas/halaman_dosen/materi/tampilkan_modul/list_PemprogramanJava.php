		...
		<table class="table table-bordered">
			...
			while($d = mysqli_fetch_array($data)){
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="deleteJ.php?id_materi=<?= $d['id_materi']; ?>" role="button"><i class="fas fa-trash-alt"></i></a> || <a class="btn btn-warning" href="edit.php?id_materi=<?= $d['id_materi']; ?>"><i class="fas fa-edit"></i></a></td>
				</tr>
				<?php
			}
